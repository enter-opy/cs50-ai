...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        neighbors = {(cell[0], cell[1] - 1), (cell[0], cell[1] + 1), (cell[0] + 1, cell[1]), (cell[0] - 1, cell[1]), (cell[0] + 1, cell[1] + 1),(cell[0] - 1, cell[1] - 1),(cell[0] + 1, cell[1] - 1),(cell[0] - 1,cell[1] + 1)}
        ...
        while True:
            ...
            for sentence1 in knowledgecopy1:
                for sentence2 in knowledgecopy1:
                    ...
                    if not(sentence1 == sentence2) and sentence1.cells.issubset(sentence2.cells) and new_sentence not in self.knowledge:
                        self.knowledge.append(new_sentence)

            if knowledgecopy0 == self.knowledge: break    
